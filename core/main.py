...
def main():
    ...
    try:
        with ThreadPoolExecutor(max_workers=args.superfastultraincridblethreads) as executor:
            futures = [
                executor.submit(scan_worker, ip, port)
                for port in ports
            ]
        ...
        print(Fore.RED + "\n[!] Scan interrompido pelo usuário (^C)")
